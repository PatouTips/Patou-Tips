...
| Functions in ``Patou Tips GitHub`` | What it is?                                                  | Functions in ``Dax Lib website``
| -----------------------------------|--------------------------------------------------------------|-----------------------------------
...
![](https://github.com/PatouTips/Patou-Tips/blob/main/%2360%20Patou%20Tips%20(Financial%20UDF%20pack%20-%20Profitability%20of%20a%20project)/Use%20function%20sample.png)

### 3 - DAX Code

#### DF - Discount Factor
> ``Function``: Patou Tip GitHub = **DF.Patou.Tips** / Dax Lib.org = **PatouTips.Finance.ProjectProfitability.DF**
```DAX
DEFINE
